...
def scrape_and_find_prices_for_multiple_codes(product_codes):
    output_csv_file = 'research_data.csv'
    output_xlsx_file = 'research_data.xlsx'
    ...
    for product_code in product_codes:
        ...
        try:
            ...
            condition_elements = driver.find_elements(By.XPATH, "//div[contains(@class,'item-condition')]")
            ...
            # Determine the most common condition, price, and location
            if prices:
                ...
                if conditions:
                    ...
                    most_common_condition, _ = condition_counter.most_common(1)[0]
                else:
                    most_common_condition = "Not Available"
                ...
                print(f"The most common condition for {product_code.strip()} is: {most_common_condition}")
                ...
                print("No prices, locations, or conditions found.")
    ...
    with open(output_csv_file, 'w', newline='', encoding='utf-8') as csvfile:
        fieldnames = ["Product Code", "Number of Items", "Highest Price", "Lowest Price", "Average Price", "Most Common Price", "Top Competitor Location", "Most Common Condition"]
